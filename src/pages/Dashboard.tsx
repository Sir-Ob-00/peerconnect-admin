      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {isLoading ? (
          ...
          <>
            ...
            <StatCard title="Learning Sessions" value={stats?.totalSessions.toString() || '0'} icon={Calendar} />
            <StatCard title="Total Reviews" value={stats?.totalReviews.toString() || '0'} icon={Star} />
